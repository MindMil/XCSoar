...
AirspaceConfigPanel::Prepare(ContainerWindow &parent, const PixelRect &rc)
{
  ...
  AddBoolean(_("Repetitive sound"), _("Enable/disable repetitive warning sound when airspaces warnings dialog is displayed."),
...
AirspaceConfigPanel::Save(bool &_changed)
{
  ...
  changed |=SaveValue(RepetitiveSound, ProfileKeys::RepetitiveSound, computer.warnings.repetitive_sound);
